...
module.exports = class App extends EventEmitter {
  ...
  startServer(callback) {
    ...
    this.server.on('browser-disconnected', this.onBrowserDisconnected.bind(this));
  ...
  onBrowserDisconnected(browserName, id, socket) {
    log.info(`browser disconnected from id=${id} browserName=${browserName}`)
