...
module.exports = class BrowserTestRunner {
  ...
  start(onFinish) {
    this.browserurl = this.launcher.settings.test_page;
    console.log(`[start()] BrowserTestRunner starting for ${this.launcher.settings.test_page}`);
  ...
  exit() {
    ...
    console.log(`[exit()] requested for ${this.browserurl}.`);
    log.info(`Closing browser ${this.name()}.`);
    return this.process.kill().then(() => {
      console.log(`[exit()] process killed for ${this.browserurl}.`);
      this.process = null;
    });
  }
  ...
  onAllTestResults() {
    console.log(`[onAllTestResults] Browser url: ${this.browserurl} finished all tests.`);
    log.info(`Browser ${this.name()} finished all tests.`, this.singleRun);
    this.onEnd();
  }

  onAfterTests() {
    console.log(`[onAfterTests] Browser url: ${this.browserurl} finished all tests.`);
    this.finish();
  }
  ...
  onDisconnect() {
    console.log(`[onDisconnect] for browser url: ${this.browserurl}`);
    this.socket = null;
  ...
  finish() {
    ...
    console.log(`[finish] Browser url: ${this.browserurl} clearing stuff up`);
    this.finished = true;
